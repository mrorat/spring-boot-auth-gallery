...
//
//        Optional<String> username = null, password = null, token = null;
//        String resourcePath = new String(new UrlPathHelper().getPathWithinApplication(httpRequest));
//
//        try {
...
//        if (authentication != null && !(authentication.getDetails().toString() == null || authentication.getDetails().toString() == "")) {
...
//        if (authentication != null && !(authentication.getPrincipal().toString() == null || authentication.getPrincipal().toString() == "")) {
